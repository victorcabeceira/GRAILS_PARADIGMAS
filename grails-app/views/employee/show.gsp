	...
	<body>
		...
		<div id="show-employee" class="content scaffold-show" role="main">
			...
			<ol class="property-list employee">
				...
				<g:if test="${employeeInstance?.s_code}">
				<li class="fieldcontain">
					<span id="s_code-label" class="property-label"><g:message code="employee.s_code.label" default="Scode" /></span>
					
						<span class="property-value" aria-labelledby="s_code-label"><g:fieldValue bean="${employeeInstance}" field="s_code"/></span>
