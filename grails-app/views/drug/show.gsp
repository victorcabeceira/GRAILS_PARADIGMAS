...
<section id="show-drug" class="first">
	...
	<table class="table">
		<tbody>
			...
			<tr class="prop">
				<td valign="top" class="name"><g:message code="drug.stock.label" default="Stock" /></td>
				
				<td valign="top" class="value">${fieldValue(bean: drugInstance, field: "stock")}</td>
			...
			<tr class="prop">
				<td valign="top" class="name"><g:message code="drug.pack.label" default="Pack" /></td>
				
				<td valign="top" class="value">${fieldValue(bean: drugInstance, field: "pack")}</td>
